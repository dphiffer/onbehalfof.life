...
$intro = "We demand that the US EPA offers environmental protection and climate justice for ALL LIFE.";
$deadline = 'August 16, 2018';

$short_example = 'On behalf of Princess Tree (Paulownia tomentosa) and its multispecies allies across the Bronx, we decry your plan to limit the use of public health data by the US EPA. Your proposed rule is a gross distortion of the call for transparency in science, and if approved, will have dire environmental justice consequences. Listen to Paulownia, an air toxicity specialist that labors in harsh urban conditions to reduce particulate matter, cool the air, and produce oxygen. Don’t use transparency in science as a trojan horse to bury public health research. Paulownia says let in the light and air, but don’t weaponize transparency! <i><a href="#worksheet">Check out the worksheet below for ideas</a> or <a href="/transparency/comments/">read some previous submissions</a>.</i>';

$example_title = 'Princess Tree (<i>Paulownia tomentosa</i>)';
$example_quote = 'On behalf of Princess Tree (Paulownia tomentosa) and its multispecies allies across the Bronx, we decry your plan to limit the use of public health data by the US EPA. Your proposed rule is a gross distortion of the call for transparency in science, and if approved, will have dire environmental justice consequences. Paulownia is very familiar with the polluted conditions of air along roadways in the Bronx, as it collects particulate matter on its large, fuzzy leaves. The Six Cities Study (air pollution research carried out in the 1990s) provided essential evidence proving what plants like Paulownia already know: air pollution is connected to premature death in humans (and plants!). These premature deaths impact poor communities of color more than other groups. Your rule would discount this important study and others like it. Rather than limiting the information used to draft environmental regulations, let’s expand our notion of expertise. Listen to Paulownia, an air toxicity specialist that labors in harsh urban conditions to reduce particulate matter, cool the air, and produce oxygen. Don’t use transparency in science as a trojan horse to bury public health research. Paulownia says let in the light and air, but don’t weaponize transparency!';
